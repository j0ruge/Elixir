...
Benchee.run(
  %{
    "Enum.filter/2 and Enum.reduce/3" => fn -> Recursion.sum_numbers_enum(list) end,
    "Body-recursive" => fn -> Recursion.sum_numbers_recursion(list) end,
    "Tail-recursive" => fn -> Recursion.sum_numbers_tail_call(list) end
  },
  time: 10,
  memory_time: 2,
  parallel: 1,
